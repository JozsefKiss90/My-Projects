  ...
  function startExperiment() {
    ...
    if (fullscreen) {
      ...
      if (keyboardNotAllowed) {
        ...
        DOM_target.append('<div class = jspsych-instructions-nav><p>A kísérlet teljes képernyős módban fog futni, amint az alábbi gombra kattintasz.</p><button id="jspsych-fullscreen-btn" class="jspsych-btn">Kísérlet indítása</button></div>');

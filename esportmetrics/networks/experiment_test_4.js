...
var practice_block = jsPsych.randomization.repeat(test_stimuli.slice(0, 3).concat(test_stimuli.slice(
...
var post_task_block = {
   ...
   questions: ['<p class = center-block-text style = "font-size: 20px">Kérlek jelezd, ha észleltél valamilyen hibát a programban.</p>'],
   rows: [15, 15],
   columns: [60,60]
};
...
var test_intro_block = {
	type: 'poldrack-text',
	text: '<div class = centerbox><p class = center-block-text>Most kezdődik a kísérleti rész. Nyomj egy <strong>enter</strong>-t a folytatáshoz.</p></div>',
	cont_key: [13],
	data: {
		trial_id: "intro",
		exp_stage: "test"
...
var end_block = {
	type: 'poldrack-text',
	text: '<div class = centerbox><p class = center-block-text>Köszönöm, hogy teljesítetted a feladatot!</p><p class = center-block-text>Nyomd meg az <strong>enter</strong>-t a befejezéshez.</p></div>',
	cont_key: [13],
	data: {
		trial_id: "end",
...
var feedback_instruct_text =
	'Üdvözöllek a  kutatásban. A kísérlet teljesítése kb. 15 percet fog igénybe venni. Nyomj egy <strong>enter</strong>-t a folyatáshoz.'
...
var instructions_block = {
	...
	pages: [
		'<div class = centerbox><p class = block-text>Ebben a kísérletben öt nyilat fogsz egymás mellett látni, amelyek jobbra vagy balra mutatnak (pl. &larr; &larr; &larr; &larr; &larr;, vagy &mdash; &mdash; &rarr; &mdash; &mdash;) és a képernyő tetején vagy alján jelenhetnek meg.</p><p class = block-text>A feladatod jelezni, hogy a középen lévő nyíl melyik irányba mutat az ennek megefelelő irányú gombok lenyomásával.</p></p></p></div>',
		'<div class = centerbox><p class = block-text> A nyilak megjelenése előtt egy * tűnhet fel a képernyő egyes pontjain.</p><p class = block-text>A * megjelenésétől függetlenül, próbálj meg mindig a lehető leggyorsabban és legpontosabban válaszolni!</p><p class = block-text>Az instrukciók befejezését követően néhány próba feladat fog következni. A próbák során visszajelzést fogsz kapni a válaszaid helyességéről. A kísérlet ezt követő részében már nem fogsz ilyen visszajezést kapni.</p></div>'
	],
	allow_keys: false,
	data: {
		trial_id: 'instruction'
...
var rest_block = {
	type: 'poldrack-text',
	text: '<div class = centerbox><p class = block-text>Most tarts egy rövid szünetet! Nyomj meg egy gombot a folytatáshoz.</p></div>',
	timing_response: 180000,
	data: {
		trial_id: "rest block"
	},
